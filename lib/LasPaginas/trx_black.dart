...
class TrxBlackPage extends StatelessWidget {
  const TrxBlackPage({super.key});
  @override
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text("TRX BLACK", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            const Text("\$8,000,000", style: TextStyle(fontSize: 20, color: Colors.green)),
          ],
        ),
      ),
    );
